    ...
    <div class="articles">
      <section class="section-articles blog">
        <div class="blog-article">
          <img class="article-img" src="<?= base_url('images/img-6.webp') ?>" />
          <h3>Introduction</h3>
          ...
          <ul class="projet-list">
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La plantation d’essences de variétés forestières et d’embellissement</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La protection de canaux existants</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>Le reprofilage, le renforcement et le maintien de talus existants</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La création de pépinières </span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>L’aménagement de cheminements piétons</span>
            </li>
          </ul>
          ...
          <table>
            ...
            <tr>
              <th>Entreprise</th>
              <td>Groupement CERCIS/SODEFOR</td>
              <!-- <td>Data 4-2</td> -->
            </tr>
          </table>
          <!-- <ul class="projet-list">
