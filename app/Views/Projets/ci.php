...
<main class="main">
  <div class="container container-articles">
    <div class="section-header">
      <h2>Le Carrefour de l'Indenié</h2>
    </div>
  </div>
  <div class="container">
    <div class="articles">
      <section class="section-articles blog">
        <div class="blog-article">
          ...
          <ul class="projet-list">
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La construction d’un canal en béton à ciel ouvert</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La construction de deux ouvrages permettant de franchir le canal de la baie de Cocody</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>L’élargissement du pont autoroutier existant</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La construction du pont de Fraternité Matin, permettant de relier Adjamé Fraternité Matin au Plateau</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>La création de nouvelles voies bitumées</span>
            </li>
            <li class="projet-list-item">
              <div class="icon-container"><ion-icon name="checkmark-outline" class="icon"></ion-icon></div>
              <span>Au carrefour Reboul : (i) la construction d’un fly-over</span>
            </li>
          </ul>
          ...
          <table>
            <tr>
              ...
              <td>Ministère de l’Equipement et de l’Entretien Routier (MEER)</td>
              <!-- <td>Data 1-2</td> -->
            </tr>
            <tr>
              <th>Maître d’Ouvrage Délégué</th>
              <td>Unité de Gestion du PABC / AGEROUTE </td>
              <!-- <td>Data 2-2</td> -->
            </tr>
            <tr>
              <th>Bailleur</th>
